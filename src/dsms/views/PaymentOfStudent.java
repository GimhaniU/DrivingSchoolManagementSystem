 ...
 * @author User
 */
public class PaymentOfStudent extends javax.swing.JInternalFrame {
     ...
     */
    public PaymentOfStudent(JFrame parent) {
        try {
            initComponents();
            this.parent = parent;
            setTitle("Payments");
            ...
            ////////////////edit payments/////////////////////////
            dtmEdit = (DefaultTableModel) editPaymentTable.getModel();
            setDataToTable(editPaymentTable, dtmEdit);
            enterEditSummary();
        } catch (SQLException | ClassNotFoundException ex) {
            Logger.getLogger(PaymentOfStudent.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        editPaymentTable = new javax.swing.JTable();
        jPanel10 = new javax.swing.JPanel();
        totalFeeLabel3 = new javax.swing.JLabel();
        totalFeeTextE = new javax.swing.JTextField();
        jLabel13 = new javax.swing.JLabel();
        discountTextE = new javax.swing.JTextField();
        jLabel27 = new javax.swing.JLabel();
        paidTotalTextE = new javax.swing.JTextField();
        jLabel28 = new javax.swing.JLabel();
        balanceToPayTextE = new javax.swing.JTextField();
        ...
        viewAllPaymentTable.getTableHeader().setReorderingAllowed(false);
        ...
        editPaymentTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Payment Id", "Attempt", "Type", "Date", "Amount"
            }
        ) {
            Class[] types = new Class [] {
        ...
        editPaymentTable.getTableHeader().setReorderingAllowed(false);
        editPaymentTable.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                editPaymentTableKeyReleased(evt);
            }
        });
        jScrollPane2.setViewportView(editPaymentTable);
        editPaymentTable.getColumnModel().getColumn(0).setPreferredWidth(10);
        editPaymentTable.getColumnModel().getColumn(1).setResizable(false);
        editPaymentTable.getColumnModel().getColumn(3).setPreferredWidth(20);
        editPaymentTable.getColumnModel().getColumn(4).setPreferredWidth(20);

        jPanel10.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        totalFeeLabel3.setText("Total fee:");

        totalFeeTextE.setEditable(false);
        totalFeeTextE.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

        jLabel13.setText("Discount:");

        discountTextE.setEditable(false);
        discountTextE.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

        jLabel27.setText("Paid Total:");

        paidTotalTextE.setEditable(false);
        paidTotalTextE.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

        jLabel28.setText("Balance To Pay:");

        balanceToPayTextE.setEditable(false);
        balanceToPayTextE.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(totalFeeLabel3)
                    .addComponent(jLabel13))
                .addGap(36, 36, 36)
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(totalFeeTextE, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(discountTextE, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(paidTotalTextE, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(balanceToPayTextE, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(163, 163, 163))
        );
        jPanel10Layout.setVerticalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(totalFeeLabel3)
                    .addComponent(totalFeeTextE, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(paidTotalTextE, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel27))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel13)
                    .addComponent(discountTextE, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(balanceToPayTextE, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel28))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        editButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dsms/icons/16x16/Options.png"))); // NOI18N
        ...
        jTabbedPane1.addTab("Edit Payment Details", new javax.swing.ImageIcon(getClass().getResource("/dsms/icons/32x32/page_edit.png")), jPanel11); // NOI18N
            ...
            if (enterPress == 1) {
                if ((todayPaymentText.getText() != "Completed") & (todayPaymentText.getText() != null)) {
                    ...
                    if (Double.valueOf(todayPaymentText.getText()) < Double.valueOf(balanceToPayText.getText())) {
                        ...
                        JOptionPane.showMessageDialog(PaymentOfStudent.this, "Rs." + (Double.valueOf(todayPaymentText.getText()) - Double.valueOf(balanceToPayText.getText())) + " is given in excess!");
    ...
    private void enterEditSummary() throws ClassNotFoundException, SQLException {
        getPaymentSummary();
        totalFeeTextE.setText(totalFee.toString());
        discountTextE.setText(discount.toString());
        paidTotalTextE.setText(paidTotal.toString());
        balanceToPayTextE.setText(balanceToPay.toString());
    }
        ...
        try {
            ...
            if (result > 0) {
                ...
                if (registration.getTotalFee() == Double.valueOf(paidTotal)) {
                    JOptionPane.showMessageDialog(PaymentOfStudent.this, "Your Training fee is Complete!");
                }
                JOptionPane.showMessageDialog(PaymentOfStudent.this, "Payment done!");
                if (payCombo.getSelectedItem().toString() == "Training Fee") {
                    ...
                    if (attemptFeeText.getText() != null) {
                        try {
                            InputStream inputStream = getClass().getResourceAsStream("/dsms/reports/paymentBillslaterAttemptBillReport.jrxml");
                            HashMap map = new HashMap();
                            map.put("registration_id", ridCombo.getSelectedItem().toString());
                            map.put("payment_id", payIdText.getText());
                            map.put("name", nameText.getText());
                ...
                JOptionPane.showMessageDialog(PaymentOfStudent.this, "Failed!");
            }
            setDataToTable(viewAllPaymentTable, dtmView);
            setDataToTable(editPaymentTable, dtmEdit);
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        try {
            ArrayList<Payment> paymentEList = new ArrayList<>();
            Registration registration = RegistrationController.searchRegistration(ridCombo.getSelectedItem().toString());
            for (int i = 0; i < dtmEdit.getRowCount(); i++) {
                Payment payment = new Payment(dtmEdit.getValueAt(i, 0).toString(), registrationId, dtmEdit.getValueAt(i, 2).toString(), dtmEdit.getValueAt(i, 3).toString(), Double.valueOf(dtmEdit.getValueAt(i, 4).toString()), Integer.valueOf(dtmEdit.getValueAt(i, 1).toString()));
                paymentEList.add(payment);
            }
            int retuenVal = PaymentController.updatePaymentSet(paymentEList);
            if (retuenVal > 0) {
                JOptionPane.showMessageDialog(PaymentOfStudent.this, "Payments Ediited!");
            } else {
                JOptionPane.showMessageDialog(PaymentOfStudent.this, "Unsuccessful!");
            }
        } catch (ClassNotFoundException | SQLException ex) {
            Logger.getLogger(PaymentOfStudent.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void editPaymentTableKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_editPaymentTableKeyReleased
        if (evt.getKeyCode() == KeyEvent.VK_DELETE) {
            int i = editPaymentTable.getSelectedRow();
            if (i != -1) {
                dtmEdit.removeRow(i);
            } else {
                JOptionPane.showMessageDialog(PaymentOfStudent.this, "Select a row to delete!");
            }
        }
    }//GEN-LAST:event_editPaymentTableKeyReleased

    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        try {
            int res = PaymentController.deletePaymentSet(studentId);
            if (res > 0) {
                JOptionPane.showMessageDialog(PaymentOfStudent.this, "Deleted!");
            } else {
                JOptionPane.showMessageDialog(PaymentOfStudent.this, "Failed!");
            }
            setDataToTable(viewAllPaymentTable, dtmView);
    ...
    private javax.swing.JTextField balanceToPayTextE;
    ...
    private javax.swing.JTextField discountTextE;
    ...
    private javax.swing.JTable editPaymentTable;
    ...
    private javax.swing.JTextField paidTotalTextE;
    ...
    private javax.swing.JLabel totalFeeLabel3;
    ...
    private javax.swing.JTextField totalFeeTextE;
